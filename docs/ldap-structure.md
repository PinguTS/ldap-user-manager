...
## 5. Organization Attribute Details
...
## 6. User Field Configuration

### 6.1 System Users (ou=people)
...
### 6.2 Organization Users (ou=people,o=OrgName)
...
## 8. Example OpenLDAP ACLs and Server Configuration
