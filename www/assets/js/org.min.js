...
;
function initCountryPickers(){"undefined"!=typeof accessibleAutocomplete&&accessibleAutocomplete.enhanceSelectElement&&document.querySelectorAll("[data-country-picker]").forEach(function(e){var t,r,a;"SELECT"===e.tagName&&"1"!==e.dataset.countryPickerInit&&(t=e.getAttribute("data-placeholder")||"Type to search a country",r=e.getAttribute("data-no-results")||"No matching country",a=e.getAttribute("data-assistive-hint")||"When autocomplete results are available use up and down arrows to review and enter to select. Touch device users, explore by touch or with swipe gestures.",accessibleAutocomplete.enhanceSelectElement({selectElement:e,showAllValues:!0,preserveNullOptions:!0,confirmOnBlur:!0,defaultValue:"",placeholder:t,tNoResults:function(){return r},tAssistiveHint:function(){return a}}),e.dataset.countryPickerInit="1")})}function initWebsiteFields(){document.querySelectorAll("[data-website-field]").forEach(function(e){var r,t,a=e.querySelector('input[type="hidden"]'),n=e.querySelector(".website-url-scheme"),i=e.querySelector(".website-url-host"),u=e.querySelector(".website-url-preview");function o(e){var e=(e||"").trim(),t=e.match(/^(https?):\/\/(.*)$/i);return t?(n.value=t[1].toLowerCase(),t[2]):e}function l(){var e=o(i.value);return""===e?"":n.value+"://"+e.replace(/^\/+/,"")}function s(){var e;u&&(e=l(),u.textContent=""===e?"":t.replace(":url",e))}function c(){var e=l();if(!i.hasAttribute("required")||""!==e){if(""===e)i.setCustomValidity(""),a.value="";else{try{var t=new URL(e);if("http:"!==t.protocol&&"https:"!==t.protocol)return i.setCustomValidity(r),0;if(!t.hostname)return i.setCustomValidity(r),0}catch(e){return i.setCustomValidity(r),0}i.setCustomValidity(""),a.value=e,i.value=o(i.value)}return 1}i.setCustomValidity(r)}function d(){c(),s()}a&&n&&i&&(r=e.getAttribute("data-invalid-msg")||"Please enter a valid website address.",t=e.getAttribute("data-preview-template")||"Will be saved as :url",n.addEventListener("change",d),i.addEventListener("input",function(){i.setCustomValidity(""),s()}),i.addEventListener("blur",d),(e=e.closest("form"))&&e.addEventListener("submit",function(e){c()||(e.preventDefault(),i.reportValidity())}),d())})}"loading"===document.readyState?document.addEventListener("DOMContentLoaded",initCountryPickers):initCountryPickers(),"loading"===document.readyState?document.addEventListener("DOMContentLoaded",initWebsiteFields):initWebsiteFields();