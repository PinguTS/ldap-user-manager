...
// If so, redirect them to their organization page since the main account_manager
// page only shows system users, which organization admins cannot manage
if (currentUserIsOrgAdmin() && !currentUserIsGlobalAdmin() && !currentUserIsMaintainer()) {
  ...
  if (isset($LDAP_DEBUG) && $LDAP_DEBUG) {
    error_log("Account Manager: Redirecting org admin '$org_name' to: $redirect_url");
  }
