...
$roles_dn = "ou=roles,o=" . ldap_escape($org_name, "", LDAP_ESCAPE_DN) . ",ou=organizations," . $LDAP['base_dn'];
$roles_search = ldap_search($ldap_connection, $roles_dn, "(objectClass=groupOfNames)");
if ($roles_search) {
